...
def load_moneyline_parlay() -> Parlay:
    legs = [
        ...
        MoneylineLeg(leg="Brazil Draw No Bet", sport="Soccer", league="FIFA World Cup", matchup="Brazil vs Croatia", start_time_et="3:00 PM ET", image_url=IMG["brazil"], probability=76.0, estimated_odds=-240, reason="Team-strength model rejects underdog upset pricing."),
...
def load_avoid_bets() -> list[AvoidBet]:
    return [
        ...
        AvoidBet(bet="Brazil ML + Over 2.5 Goals + Vinicius Jr. anytime scorer", sport="Soccer", league="FIFA World Cup", matchup="Brazil vs Croatia", market="Same-game parlay", sportsbook_odds=+220, start_time_et="3:00 PM ET", image_url=IMG["brazil"], category="Public-heavy trap", risk="Extreme", reason="The legs look correlated, but Croatia tempo pushes against the over and anytime scorer pricing is heavily taxed. Brazil double chance or draw no bet is the disciplined angle."),
